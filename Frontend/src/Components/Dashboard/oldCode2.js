...
export default function Dashboard(props) {
  ...
  const [dataView5, setDataView5] = useState("");
  const [dataView6, setDataView6] = useState("");
  ...
  const selectDataView = (event) => {
    if (event.target.id === "dataViewSelect1") {
      ...
      if(event.target.value !== "") {
        ...
        } else if (event.target.value === document.getElementById("dataViewSelect5").value) {
          // If trying to switch to a data view that is already being displayed in the bottom right section, switch the
          // data views in this section and the other one
          setDataView5(dataView1);
        } else if (event.target.value === document.getElementById("dataViewSelect6").value) {
          // If trying to switch to a data view that is already being displayed in the bottom right section, switch the
          // data views in this section and the other one
          setDataView6(dataView1);
        }
      }
      ...
      if(event.target.value !== "") {
        if (event.target.value === document.getElementById("dataViewSelect1").value) {
          ...
          // If trying to switch to a data view that is already being displayed in the bottom right section, switch the
          // data views in this section and the other one
          setDataView5(dataView2);
        } else if (event.target.value === document.getElementById("dataViewSelect6").value) {
          // If trying to switch to a data view that is already being displayed in the bottom right section, switch the
          // data views in this section and the other one
          setDataView6(dataView2);
        }
      }
      ...
      if(event.target.value !== "") {
        if (event.target.value === document.getElementById("dataViewSelect1").value) {
          ...
          // If trying to switch to a data view that is already being displayed in the bottom right section, switch the
          // data views in this section and the other one
          setDataView5(dataView3);
        } else if (event.target.value === document.getElementById("dataViewSelect6").value) {
          // If trying to switch to a data view that is already being displayed in the bottom right section, switch the
          // data views in this section and the other one
          setDataView6(dataView3);
        }
      }
      ...
      if(event.target.value !== "") {
        if (event.target.value === document.getElementById("dataViewSelect1").value) {
          ...
          // If trying to switch to a data view that is already being displayed in the bottom right section, switch the
          // data views in this section and the other one
          setDataView5(dataView4);
        } else if (event.target.value === document.getElementById("dataViewSelect6").value) {
          // If trying to switch to a data view that is already being displayed in the bottom right section, switch the
          // data views in this section and the other one
          setDataView6(dataView4);
        }
      }
      setDataView4(event.target.value);
    } else if (event.target.id === "dataViewSelect5") {
      // Avoid duplicate data views, unless they are both empty
      if(event.target.value !== "") {
        if (event.target.value === document.getElementById("dataViewSelect1").value) {
          // If trying to switch to a data view that is already being displayed in the top left section, switch the
          // data views in this section and the other one
          setDataView1(dataView5);
        } else if (event.target.value === document.getElementById("dataViewSelect2").value) {
          // If trying to switch to a data view that is already being displayed in the top right section, switch the
          // data views in this section and the other one
          setDataView2(dataView5);
        } else if (event.target.value === document.getElementById("dataViewSelect3").value) {
          // If trying to switch to a data view that is already being displayed in the bottom left section, switch the
          // data views in this section and the other one
          setDataView3(dataView5);
        } else if (event.target.value === document.getElementById("dataViewSelect4").value) {
          // If trying to switch to a data view that is already being displayed in the bottom right section, switch the
          // data views in this section and the other one
          setDataView4(dataView5);
        } else if (event.target.value === document.getElementById("dataViewSelect6").value) {
          // If trying to switch to a data view that is already being displayed in the bottom right section, switch the
          // data views in this section and the other one
          setDataView6(dataView5);
        }
      }
      setDataView5(event.target.value);
  } else if (event.target.id === "dataViewSelect6") {
      // Avoid duplicate data views, unless they are both empty
      if(event.target.value !== "") {
        if (event.target.value === document.getElementById("dataViewSelect1").value) {
          // If trying to switch to a data view that is already being displayed in the top left section, switch the
          // data views in this section and the other one
          setDataView1(dataView6);
        } else if (event.target.value === document.getElementById("dataViewSelect2").value) {
          // If trying to switch to a data view that is already being displayed in the top right section, switch the
          // data views in this section and the other one
          setDataView2(dataView6);
        } else if (event.target.value === document.getElementById("dataViewSelect3").value) {
          // If trying to switch to a data view that is already being displayed in the bottom left section, switch the
          // data views in this section and the other one
          setDataView3(dataView6);
        } else if (event.target.value === document.getElementById("dataViewSelect4").value) {
          // If trying to switch to a data view that is already being displayed in the bottom right section, switch the
          // data views in this section and the other one
          setDataView4(dataView6);
        } else if (event.target.value === document.getElementById("dataViewSelect5").value) {
          // If trying to switch to a data view that is already being displayed in the bottom right section, switch the
          // data views in this section and the other one
          setDataView5(dataView6);
        }
      }
      setDataView6(event.target.value);
    }
  }
  ;
  ...
  const [selColorStr5, setSelColorStr5] = useState(selectTxtCol);
  const [selColorStr6, setSelColorStr6] = useState(selectTxtCol);
  ...
  const _updateSelColor = (targetId, newColor) => {
    switch (targetId) {
      ...
      case "dataViewSelect4":
        ...
        break;
      case "dataViewSelect5":
        setSelColorStr5(newColor);
        break;
      case "dataViewSelect6":
        setSelColorStr6(newColor);
        break;
    }
  }
  ...
  return (
    <HStack h="100vh" w="100vw" align="stretch" spacing={0}>
      ...
      <Grid margin={0.5} gap={1} flex="1 1 0" templateRows="2fr 3fr 3fr" templateColumns="1fr 1fr 1fr" >
        <GridItem
          minH="min-content"
          rowStart={1}
          rowSpan={1}
...
>
  <Select
    ...
    focusBorderColor={borderCol}
    value={dataView5}
    onFocus={() => {setSelectFocus("dataViewSelect5")}}
    onBlur={removeSelectFocus}
    onMouseEnter={changeSelColor}
    onMouseLeave={changeSelColorBack}
    onChange={selectDataView}
...
>
  <Select
    ...
    focusBorderColor={borderCol}
    value={dataView6}
    onFocus={() => {setSelectFocus("dataViewSelect6")}}
    onBlur={removeSelectFocus}
    onMouseEnter={changeSelColor}
    onMouseLeave={changeSelColorBack}
    onChange={selectDataView}
